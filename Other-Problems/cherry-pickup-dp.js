...
var cherryPickup = function (grid) {
  ...
  return Math.max(0, cherryPickupHelper(grid, n, 0, 0, 0, dp));
};

let cherryPickupHelper = function (grid, n, r1, c1, c2, dp) {
  let r2 = r1 + c1 - c2;
  ...
  cherries += Math.max(
    Math.max(cherryPickupHelper(grid, n, r1 + 1, c1, c2, dp), cherryPickupHelper(grid, n, r1 + 1, c1, c2 + 1, dp)),
    Math.max(cherryPickupHelper(grid, n, r1, c1 + 1, c2, dp), cherryPickupHelper(grid, n, r1, c1 + 1, c2 + 1, dp))
  );
